...
linkedin_agent = Agent(
    name="Linkedin Agent",
    instructions="""
        You are a helpful assistant that can help with LinkedIn posts. You can help with the following:
        - Writing LinkedIn posts

        Here is an example of a LinkedIn post I have created in my writing style and did well:
        ...
        Okay, that was an example I want you to create a post similar to.  Take the input transcription and create a post from it similar to the above example.
